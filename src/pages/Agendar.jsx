...
const Agendar = () => {
    ...
    const getServices = () => {
        try {
            console.log(searchContext.stateLogin.session);
    ...
    const searchAvailability = (data) => {
        ...
        let formattedDate = `${data.date.getUTCFullYear()}-${
            data.date.getMonth() + 1 < 10
                ? `0${data.date.getMonth() + 1}`
                            ...
                            render={({
                                ...
                                <ThemeProvider theme={theme}>
                                    ...
                                    >
                                        ...
                                        >
                                            <ThemeProvider theme={themeDefalut}>
                                                <DatePicker
                        ...
                        {idServiceSelected && getValues("date") ? (
                            <div className="service-summary">
                                ...
                                {serviceSelected.instrucoes ? (
                                    <p>
                                        Instruções: {serviceSelected.instrucoes}
                                    </p>
                                ) : null}
                            </div>
                        ) : null}
